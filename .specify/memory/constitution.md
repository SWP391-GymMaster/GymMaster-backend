...
Coverage ≥ 80% business logic; mỗi endpoint có happy path + ≥1 error case. Trước merge phải qua Validation Gate 4 lớp (Automated → Spec compliance → Constitution → Acceptance) — xem `docs/init/09_TEST_PLAN.md` §6. Không tin "AI đã xong"; tin khi test xanh + checklist tick.
