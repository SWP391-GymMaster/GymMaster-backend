...
|---|---|---|---|---|---|
| POST | /api/packages | Admin | {name, durationDays, price, **supportsPT**} | 201 | 400 |
| PUT | /api/packages/{id} | Admin | {…, status, **supportsPT**} | 200 | 400, 404 |
| GET | /api/packages | Admin, Staff | — | 200 (mỗi gói kèm `supportsPT`) | 401 |
