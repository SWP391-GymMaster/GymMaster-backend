...
public sealed class UserService : IUserService
{
    ...
    public async Task<AuthServiceResult<AdminUserResponse>> UpdateStatusAsync(
        long id,
        string status,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<AuthServiceResult<ResetUserPasswordResponse>> ResetPasswordAsync(
        long id,
        CancellationToken cancellationToken)
    {
        var user = await FindAsync(id, cancellationToken);
        ...
        return AuthServiceResult<ResetUserPasswordResponse>.Success(
