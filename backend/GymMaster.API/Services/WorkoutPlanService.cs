...
public sealed class WorkoutPlanService : IWorkoutPlanService
{
    ...
    public async Task<AuthServiceResult<WorkoutPlanResponse>> CreateAsync(
        long memberId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return AuthServiceResult<WorkoutPlanResponse>.Success(
            ToResponse(plan, memberProfile, trainerProfile),
            StatusCodes.Status201Created);
    }

    // FR-WP-02: PT sua bai tap trong plan cua minh.
    public async Task<AuthServiceResult<WorkoutPlanResponse>> UpdateAsync(
        long planId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return AuthServiceResult<WorkoutPlanResponse>.Success(ToResponse(plan, plan.Member, trainerProfile));
    }
    ...
    public async Task<AuthServiceResult<IReadOnlyList<WorkoutPlanResponse>>> GetByMemberAsync(
        long memberId,
        ClaimsPrincipal principal,
        CancellationToken cancellationToken)
    {
        ...
        return AuthServiceResult<IReadOnlyList<WorkoutPlanResponse>>.Success(result);
    }
