...
public sealed class VnPayService : IVnPayService
{
    ...
    public async Task<AuthServiceResult<CreateVnPayPaymentResponse>> CreatePaymentUrlAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return AuthServiceResult<CreateVnPayPaymentResponse>.Success(
    ...
    public async Task<AuthServiceResult<VnPayPaymentStatusResponse>> HandleReturnAsync(
        IReadOnlyDictionary<string, string> query,
        CancellationToken cancellationToken)
    {
        if (!TryVerify(query, out var inputHash) || !ValidateSignature(query, inputHash))
        ...
        return AuthServiceResult<VnPayPaymentStatusResponse>.Success(
