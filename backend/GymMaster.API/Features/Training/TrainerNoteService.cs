...
public sealed class TrainerNoteService : ITrainerNoteService
{
    ...
    public async Task<ServiceResult<TrainerNoteResponse>> CreateAsync(
        long memberId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<TrainerNoteResponse>.Success(
    ...
    public async Task<ServiceResult<IReadOnlyList<TrainerNoteResponse>>> GetByMemberAsync(
        long memberId,
        ClaimsPrincipal principal,
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<IReadOnlyList<TrainerNoteResponse>>.Success(result);
    }

    // FR-NOTE-02: PT sua ghi chu cua chinh minh.
    public async Task<ServiceResult<TrainerNoteResponse>> UpdateAsync(
        long noteId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<TrainerNoteResponse>.Success(ToResponse(note, note.Member, trainerProfile));
    }
