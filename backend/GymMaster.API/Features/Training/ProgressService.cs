...
public sealed class ProgressService : IProgressService
{
    ...
    // FR-PROG-01
    public async Task<ServiceResult<ProgressResponse>> RecordAsync(
        long memberId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<ProgressResponse>.Success(
            ToResponse(log),
            isUpdate ? StatusCodes.Status200OK : StatusCodes.Status201Created);
    }

    // FR-PROG-03
    public async Task<ServiceResult<IReadOnlyList<ProgressResponse>>> GetTimelineAsync(
        long memberId,
        ClaimsPrincipal principal,
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<IReadOnlyList<ProgressResponse>>.Success(
            logs.Select(ToResponse).ToList());
    }

    // FR-360-01
    public async Task<ServiceResult<Profile360Response>> GetProfile360Async(
        long memberId,
        ClaimsPrincipal principal,
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<Profile360Response>.Success(response);
    }
