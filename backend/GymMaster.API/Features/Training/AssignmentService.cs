...
public sealed class AssignmentService : IAssignmentService
{
    ...
    public async Task<ServiceResult<TrainerAssignmentResponse>> AssignAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<TrainerAssignmentResponse>.Success(
    ...
    public async Task<ServiceResult<AssignmentCandidateListResponse<AssignmentCandidateMemberResponse>>> GetCandidateMembersAsync(
        string? query,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<AssignmentCandidateListResponse<AssignmentCandidateMemberResponse>>.Success(
    ...
    public async Task<ServiceResult<AssignmentCandidateListResponse<AssignmentCandidateTrainerResponse>>> GetCandidateTrainersAsync(
        string? query,
        string? specialty,
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<AssignmentCandidateListResponse<AssignmentCandidateTrainerResponse>>.Success(
    ...
    public async Task<ServiceResult<IReadOnlyList<AssignedMemberResponse>>> GetAssignedMembersAsync(
        ClaimsPrincipal principal,
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<IReadOnlyList<AssignedMemberResponse>>.Success(result);
    }
