...
public sealed class PaymentService : IPaymentService
{
    ...
    public async Task<ServiceResult<PagedResult<PaymentHistoryResponse>>> GetAllAsync(
        DateOnly? from,
        DateOnly? to,
        string? status,
        long? memberId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<PagedResult<PaymentHistoryResponse>>.Success(result);
    }

    public async Task<ServiceResult<IReadOnlyList<PaymentHistoryResponse>>> GetByMemberAsync(
        long memberId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<IReadOnlyList<PaymentHistoryResponse>>.Success(
            rows.Select(ToResponse).ToList());
    }

    public async Task<ServiceResult<PaymentSummaryResponse>> GetSummaryAsync(
        DateOnly? from,
        DateOnly? to,
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<PaymentSummaryResponse>.Success(result);
    }
    ...
    private static ServiceResult<T> Fail<T>(
        string code,
        string message,
