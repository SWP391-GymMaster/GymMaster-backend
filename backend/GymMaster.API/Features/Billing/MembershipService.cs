...
public sealed class MembershipService : IMembershipService
{
    ...
    // FR-MS-01
    public async Task<ServiceResult<SellMembershipResponse>> SellAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return ServiceResult<SellMembershipResponse>.Success(new SellMembershipResponse(ToResponse(pending)));
        }
        ...
        return ServiceResult<SellMembershipResponse>.Success(
            new SellMembershipResponse(ToResponse(membership)),
            StatusCodes.Status201Created);
    }

    // FR-MS-02 / FR-PAY-01
    public async Task<ServiceResult<ConfirmPaymentResult>> ConfirmPaymentAsync(
        long id,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<ConfirmPaymentResult>.Success(
    ...
    // FR-MS-03
    public async Task<ServiceResult<MembershipResponse>> RenewAsync(
        long id,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<MembershipResponse>.Success(ToResponse(membership));
    }

    // FR-MS-04
    public async Task<ServiceResult<MembershipResponse>> CreateRenewalRequestAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (pending is not null)
        {
            return ServiceResult<MembershipResponse>.Success(ToResponse(pending));
        }
        ...
        return ServiceResult<MembershipResponse>.Success(
            ToResponse(membership),
            StatusCodes.Status201Created);
    }
    ...
    public async Task<ServiceResult<MembershipResponse>> CancelAsync(
        long id,
        ClaimsPrincipal principal,
        CancellationToken cancellationToken)
    {
    ...
    // FR-MS-09
    public async Task<ServiceResult<IReadOnlyList<MembershipResponse>>> GetMembershipsForMemberAsync(
        long memberId,
        ClaimsPrincipal principal,
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<IReadOnlyList<MembershipResponse>>.Success(
    ...
    public async Task<ServiceResult<PagedResult<MembershipResponse>>> GetAllAsync(
        string? status,
        int? page,
        ClaimsPrincipal principal,
        CancellationToken cancellationToken)
    ...
    private static ServiceResult<T> PackagePtMismatch<T>()
    {
