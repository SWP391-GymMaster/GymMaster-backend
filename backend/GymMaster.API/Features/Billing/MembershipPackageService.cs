...
public sealed class MembershipPackageService : IMembershipPackageService
{
    ...
    // FR-PKG-01
    public async Task<ServiceResult<PackageResponse>> CreateAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<PackageResponse>.Success(ToResponse(package), StatusCodes.Status201Created);
    }

    // FR-PKG-01
    public async Task<ServiceResult<PackageResponse>> UpdateAsync(
        long id,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<PackageResponse>.Success(ToResponse(package));
    }

    // FR-PKG-03
    public async Task<ServiceResult<IReadOnlyList<PackageResponse>>> ListAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<IReadOnlyList<PackageResponse>>.Success(
