...
public sealed class AuthService : IAuthService
{
    ...
    public async Task<ServiceResult<AuthLoginResponse>> RegisterAsync(
    ...
    public async Task<ServiceResult<AuthLoginResponse>> RefreshAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<object>.Success(new { message = "Dat lai mat khau thanh cong." });
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<object>.Success(new { message = "Doi mat khau thanh cong." });
    }

    public async Task<ServiceResult<AuthLoginResponse>> GoogleLoginAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<AuthUserResponse>.Success(ToUserResponse(user, memberProfileId));
    }
    ...
    private async Task<ServiceResult<AuthLoginResponse>> CreateLoginResponseAsync(
        User user,
        CancellationToken cancellationToken,
    ...
    private static ServiceResult<T> Failure<T>(string code, string message, int statusCode)
    {
