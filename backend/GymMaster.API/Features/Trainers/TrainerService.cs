...
public sealed class TrainerService : ITrainerService
{
    ...
    // FR-PT-PROF-01: tao tai khoan (role pt) + ho so nghe trong 1 buoc.
    public async Task<ServiceResult<CreateTrainerResponse>> CreateAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Fail<CreateTrainerResponse>("VALIDATION_ERROR", personError, StatusCodes.Status400BadRequest);
        }
        ...
        return ServiceResult<CreateTrainerResponse>.Success(
            new CreateTrainerResponse(ToResponse(profile), password, autoGenerated),
            StatusCodes.Status201Created);
    }

    public async Task<ServiceResult<PagedResult<TrainerResponse>>> ListAsync(
        string? query,
        int page,
        int pageSize,
        CancellationToken cancellationToken)
    {
        ...
        return ServiceResult<PagedResult<TrainerResponse>>.Success(result);
    }

    public async Task<ServiceResult<TrainerResponse>> GetByIdAsync(long id, CancellationToken cancellationToken)
    {
        ...
        return profile is null
            ...
            : ServiceResult<TrainerResponse>.Success(ToResponse(profile));
    }

    public async Task<ServiceResult<TrainerResponse>> GetCurrentAsync(
    ...
    public async Task<ServiceResult<TrainerResponse>> UpdateAsync(
        long id,
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (personError is not null)
        {
            return Fail<TrainerResponse>("VALIDATION_ERROR", personError, StatusCodes.Status400BadRequest);
        }
        ...
        return ServiceResult<TrainerResponse>.Success(ToResponse(profile));
    }
