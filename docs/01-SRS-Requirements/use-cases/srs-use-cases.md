...
**Status:** Implemented — đồng bộ code 2026-07-15 (4 Roles). Chi tiết API/mã lỗi ở `docs/03-Interface-Specs/feature-specs/001-010/`.
...
- [ ] Mỗi Acceptance Criteria **test được** (map ra test case ở `test-plan.md`).
