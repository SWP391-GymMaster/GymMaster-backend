...
- **Override ADR-03**: MVP gốc chốt thủ công; spec này bổ sung cổng online theo yêu cầu giảng viên. Luồng thủ công (`POST /memberships/{id}/payment`) **vẫn giữ** làm fallback. Đề nghị log quyết định ở `docs/06-Management/decision-log.md`.
