...
- [X] T014 [US1] Cắm audit cho **giáo án + ghi chú** (spec 005) — `WorkoutPlanService` và `TrainerNoteService` đều inject `IAuditService`, ghi đủ 6 action `CREATE/UPDATE/DELETE`. AUDIT-01 phủ đủ **36 action / 15 service** (xem `plan.md` §7.1)
