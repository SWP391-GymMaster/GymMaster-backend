...
- [X] T020 [US1] Unit test `tests/GymMaster.Api.Tests/AuthServiceTests.cs` — 18 test: cửa sổ trượt chống brute-force, khoá tạm, rotate refresh token, logout revoke, OTP sai 3 lần, đổi mật khẩu
