...
> Dự án dùng **GitHub Spec Kit**. Nguồn sự thật cho từng feature là `docs/03-Interface-Specs/feature-specs/NNN-*/spec.md`.
1. **Spec là hợp đồng:** Mỗi feature phải có `docs/03-Interface-Specs/feature-specs/NNN-*/spec.md` ở trạng thái **Approved** trước khi plan/code. Đọc nó trước tiên (index: `docs/03-Interface-Specs/feature-specs/README.md`).
...
5. **1 feature = 1 nhánh `NNN-*`.** Đổi business rule → cập nhật `spec.md` + `decision-log.md` trong cùng PR.
...
1. **Spec-first:** Trước khi code, đọc spec liên quan (`docs/03-Interface-Specs/feature-specs/NNN-*/spec.md`, và `03/04/06`). Không có spec rõ → hỏi, KHÔNG tự bịa.
