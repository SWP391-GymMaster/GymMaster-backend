...
>
> Backlog hiện hành: **[`docs/03-Interface-Specs/feature-specs/BACKLOG.md`](../03-Interface-Specs/feature-specs/BACKLOG.md)** — 20 mục rút từ việc đối chiếu spec ↔ code, có ưu tiên P1→P5 và điều kiện hoàn thành.
>
> Giữ lại làm **dấu vết kế hoạch ban đầu** (epic, story point, phân phase).

# 08 — Tasks Backlog *(Superseded)*
