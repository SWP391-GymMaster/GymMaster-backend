...
> Chỉ rõ chỗ khác giữa DB hiện tại (`GymMaster_SQLServer_Final.sql`) và schema đúng theo code backend. Làm theo cột **MỚI**. Chi tiết đầy đủ ở `docs/02-SDD-Architecture/15_DATABASE_SCHEMA.md`.
