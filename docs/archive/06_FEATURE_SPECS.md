...
>
> Bản phác thảo F1–F5 ở mức cao, 8 thành phần. Đã được thay bằng **[`docs/03-Interface-Specs/feature-specs/`](../03-Interface-Specs/feature-specs/README.md)** — 10 feature, 9 thành phần, đồng bộ từ code thật, kèm `plan.md` + `tasks.md`.
>
> Giữ lại làm **dấu vết thiết kế ban đầu**. Nội dung bên dưới có chỗ **không còn đúng với code** (xem chính ghi chú của file: phân công PT, giới hạn check-in, VNPay, Gemini).

# 06 — FEATURE SPECS

**Status:** ~~Implemented~~ → **Superseded** (archive 2026-07-23)
