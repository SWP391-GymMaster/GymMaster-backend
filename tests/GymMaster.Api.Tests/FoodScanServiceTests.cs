...
public sealed class FoodScanServiceTests
{
    ...
    private sealed class FakeAnalyzer : IFoodImageAnalyzer
    {
        ...
        private FakeAnalyzer(FoodImageAnalysisResult<IReadOnlyList<DetectedFood>> result)
        {
            _result = result;
        }
        ...
        public static FakeAnalyzer Success(IReadOnlyList<DetectedFood> foods)
            => new(FoodImageAnalysisResult<IReadOnlyList<DetectedFood>>.Success(foods));

        public static FakeAnalyzer Failure(string code, string message)
            => new(FoodImageAnalysisResult<IReadOnlyList<DetectedFood>>.Failure(code, message));
